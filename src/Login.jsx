...
const users = [
    { id: 1, name: 'weather', email: 'demo1@gmail.com', password: 'weather' },
        ...
        <>  
            <div className="flex h-screen w-full items-center justify-center bg-gray-100 px-4">
                <div className="w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-lg sm:flex" >
                    <div className="m-0 md:w-7/12 md:h-[22em] h-80 rounded-3xl bg-gray-400 bg-cover bg-center " style={{
                    ...
                    <div className="w-full sm:w-3/5 z-10 bg-red">
                        <div className="p-4">
                            ...
                            <p className="mt-2 text-base leading-tight text-gray-600">Welcom to Weather React app</p>
                            <h1 className="mt-3  text-red-500">Name & Password : <strong>weather</strong> </h1>
